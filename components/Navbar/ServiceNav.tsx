...
const ServiceNav = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="lg:px-4 lg:border-r-[1px] mb-4 lg:mb-0 lg:pr-10 pl-4 sm:pl-0 ">
        ...
        <div className="lg:px-8 lg:pr-20 py-2 max-lg:pl-6 hidden lg:flex">
          <span className="my-1 text-neutral-800 font-semibold">
            SaaS - Tools
          </span>
