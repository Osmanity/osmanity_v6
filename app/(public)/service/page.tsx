...
import Clouds2 from "@/components/Space/Clouds2";
import StarsCanvas from "@/components/Space/StarBackground2";
import SunRise from "@/components/Space/SunRise";
...
export default async function Home() {
  // await delay(5000);
  return (
    <div className="relative min-h-screen overflow-hidden dark:bg-[#050016] bg-[#F3F5F8] dark:text-white text-black">
      <div className="relative w-full min-h-screen overflow-hidden hero-section">
        ...
        <video
          ...
          muted
          loop
          className="hidden dark:block rotate-180 rounded-2xl absolute top-[-250px]  h-full w-full lg:w-4/5 min-h-[940px] sm:min-h-[1000px] -left-28 lg:-left-14 z-[10]  sm:object-contain  "
        >
        ...
        <div className="absolute top-0 left-0 z-[12] w-full min-h-[940px] sm:min-h-[1000px] dark:bg-black/50  " />
        <div className=" w-full">
          <Hero />
        </div>
      </div>
      <div className="relative z-30 w-full min-h-screen overflow-hidden">
        <VideoExplainer1 />
        <VideoExplainer4 />
        <CarouselSection />
        <VideoExplainer2 />
